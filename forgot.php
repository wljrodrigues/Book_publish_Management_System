...
if(isset($_POST['submit']))
{
    ...
    $sql = "SELECT userVerificationCode,userName FROM users WHERE userEmail='$username'";
    ...
    if ($query) {
        ...
        $body = "Hi, $name. Click the link to reset your account password http://localhost/Mscit/Library%20Management/reset.php?token=$token";
